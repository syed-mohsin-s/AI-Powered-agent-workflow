...
from sentinel_ai.models.workflow import WorkflowExecution
...
class SLATracker:
    ...
    def __init__(
        self, workflow_id: str, deadline: datetime, warning_threshold: float = 0.75
    ):
                ...
                await self._event_bus.publish(
                    Event(
                        ...
                        data={
                            ...
                            "deadline": tracker.deadline.isoformat(),
                            "overdue_seconds": abs(
                                tracker.time_remaining.total_seconds()
                            ),
                        },
                        source="scheduler",
                    )
