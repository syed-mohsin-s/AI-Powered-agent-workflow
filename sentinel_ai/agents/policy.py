...
class PolicyAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        self._rules = {
            "p2p": [
                {
                    "name": "amount_limit",
                    "check": self._check_amount_limit,
                    "priority": "high",
                },
                {
                    "name": "po_required",
                    "check": self._check_po_required,
                    "priority": "high",
                },
                {
                    "name": "vendor_approved",
                    "check": self._check_vendor_approved,
                    "priority": "medium",
                },
                {
            ...
            "onboarding": [
                {
                    "name": "role_approved",
                    "check": self._check_role_approved,
                    "priority": "high",
                },
                {
                    "name": "background_check",
                    "check": self._check_background,
                    "priority": "high",
                },
                {
                    "name": "equipment_policy",
                    "check": self._check_equipment_policy,
                    "priority": "low",
                },
            ],
            "contract_clm": [
    ...
    async def execute(self, context: dict) -> TaskResult:
        ...
        confidence = sum(r.get("confidence", 0.8) for r in results) / max(
            len(results), 1
        )
